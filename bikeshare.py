...
def station_stats(df):
    ...
    print("The most frequent combination of Start and End Station is {} ".format(comb_start_end))
...
def display_data(df):
    ...
    while True:
        response = ['yes','no']
        choice = input("Would you like to view 5 lines of raw data? Type 'yes' or 'no'\n").lower()
    ...
    if  choice =='yes':       
            while True:
                choice_2= input("Would you like to view more raw data? Type 'yes' or 'no'\n").lower()
